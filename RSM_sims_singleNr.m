%% MATLAB SCRIPT THAT GENERATES SIMULATIONS FOR RSM_RIS WITH FIXED NR
...
Na = 3;
if Nrx < Na
    quit;   % Make sure Nrx is ALWAYS >= Na
end
%% DIRECT CHANNEL - Hbu
...
Hbu_og = Hbu_og./beta_bu;   % Channel normalization
...
Ny_t = 1600;                            % Nº of RIS elements
if(RIS==2)
    Ny = [Ny_t,Ny_t]./2;                % Nº of elements per col
end
...
matHbr = cell2mat(Hbr.')./beta_bu;      % Normalize compound channel
%matHbr = cell2mat(Hbr.');
matHru = cell2mat(Hru);
